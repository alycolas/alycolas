...
menubar.set_icon_theme("zhongguo")
menubar.g = {
	height = 27,
	--width = 600,
	x = 0,
...
local wallpaper_cmd = "find " .. wallpaper_dir .. " -type f -name '*.*'  -print0 | shuf -n1 -z | xargs -0 feh --bg-center"
...
vicious.register(fs.s, vicious.widgets.fs, "${/home/alycolas used_p}", 599)
...
--vipious.register(volbar,    vicious.widgets.volume,  "$1",  2, "Master")
...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey, 		  }, "F1", function () exec("dmenu_run -fn 14 -b") end),
	awful.key({ modkey,"Shift" 	  }, "o", function () exec("opera-next") end),
	awful.key({ modkey, 		  }, "e", function () exec("pcmanfm") end),
	awful.key({ modkey,"Control"  }, "l", function () exec("xset dpms force off") end),
	awful.key({ modkey, "Control" }, "Escape", function () exec("gksudo halt") end),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "t",      function (c) c.above = false 				 end),
...
awful.rules.rules = {
    ...
    { rule = { class = "Gvim" }, 		properties = { size_hints_honor = true, floating = false } },
    { rule = { class = "MPlayer" }, 	properties = { size_hints_honor = true, floating = true } },
    { rule = { class = "Vlc" }, 	properties = { size_hints_honor = true, floating = true } },
    { rule = { class = "Adl" }, 	properties = { floating = true } },
    { rule = { class = "Stardict" }, 	properties = { floating = true } },
    -- { rule = { class = "OperaNext" }, 	properties = { floating = false} },
    { rule = { class = "pinentry" }, 	properties = { floating = true } },
    { rule = { class = "feh" }, 	properties = { floating = true } },
    { rule = { class = "Gimp" }, 		properties = { floating = true, screen = mouse.screen} },
