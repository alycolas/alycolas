...
var a={mkCompat:function(d,c,e){if(c.options.compat_metadata||e){d=a.unMetaDataify(d)
...
}return d},findPrototypes:function(e){if(e.search(b.escapeForRegExp(".toSource("))!=-1){return true
...
o=o.replace(/^\n/g,"").replace(/\n$/g,"");var k=l+m+j;
q=q.replace(k,'(new CDATA("'+o+'"))')}r=r.substr(1,r.length-1);
